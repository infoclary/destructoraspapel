	...
	<div class="row ">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 img1">
				<div class="col-lg-5 col-md-5 col-sm-12 col-xs-12">
					...
					<img class="img-responsive img-boton1" src="<?php bloginfo('template_url'); ?>/images/botton.png" alt="destructoras industriales">
					</a>
				</div>
				<div class="col-lg-2 col-md-2 hidden-sm hidden-xs o">
					<img class="img-responsive " src="<?php bloginfo('template_url'); ?>/images/o.png" alt="destructoras de carton">
				</div>
